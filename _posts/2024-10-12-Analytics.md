...
![]({{ "/assets/images/analytics/Pasted image 20260222122850.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241012133105.webp" | relative_url }})

Ports 80 (HTTP) and 22 (SSH) are open. We run nmap again to see the version and service running on the open ports

![]({{ "/assets/images/analytics/Pasted image 20241012133115.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241012133154.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241012133203.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241012133228.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241012133239.webp" | relative_url }})
![]({{ "/assets/images/analytics/Pasted image 20241012133248.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241012133341.webp" | relative_url }})

First, they tell us that we have to look for the setup-token value in the path /api/session/properties.

![]({{ "/assets/images/analytics/Pasted image 20241012133346.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241012133435.webp" | relative_url }})

Now we run the exploit, we have to print the string, decode it and pipe it with bash, we listen on port 443:
![]({{ "/assets/images/analytics/Pasted image 20241012133453.webp" | relative_url }})
![]({{ "/assets/images/analytics/Pasted image 20241012133457.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241012133504.webp" | relative_url }})

Looking inside the container, in the metabase.db/ directory, we find what appear to be credentials:

![]({{ "/assets/images/analytics/Pasted image 20241012133551.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241012133600.webp" | relative_url }})

We test the credentials via SSH and access the machine as the user metalytics.

![]({{ "/assets/images/analytics/Pasted image 20241012133611.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241012133750.webp" | relative_url }})

We are looking for files that have SUID permissions, but there are none of interest.

![]({{ "/assets/images/analytics/Pasted image 20241012133756.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241012133801.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241012133812.webp" | relative_url }})
...
```
![]({{ "/assets/images/analytics/Pasted image 20241012133828.webp" | relative_url }})
...
```
![]({{ "/assets/images/analytics/Pasted image 20241012134405.webp" | relative_url }})
