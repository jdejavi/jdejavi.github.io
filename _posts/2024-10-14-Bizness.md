...
![]({{ "/assets/images/analytics/bizness_card.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241014132140.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241014132147.webp" | relative_url }})

From the nmap capture, we see that a redirection is made to the domain `bizness.htb`, so we add it to `/etc/hosts`.

![]({{ "/assets/images/analytics/Pasted image 20241014132159.webp" | relative_url }})

## 80 - HTTP

We launched WhatWeb to learn more about web services.

![]({{ "/assets/images/analytics/Pasted image 20241014132205.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241014132210.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241014132215.webp" | relative_url }})

We observe a directory called `/control`. Let's see what this directory contains.

![]({{ "/assets/images/analytics/Pasted image 20241014132222.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241014132229.webp" | relative_url }})
![]({{ "/assets/images/analytics/Pasted image 20241014132234.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241014132631.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241014132636.webp" | relative_url }})

We will listen on port 1234 with netcat and send ourselves a reverse shell.

![]({{ "/assets/images/analytics/Pasted image 20241014132648.webp" | relative_url }})
![]({{ "/assets/images/analytics/Pasted image 20241014132653.webp" | relative_url }})

We have access to the victim machine and can see the user flag.

![]({{ "/assets/images/analytics/Pasted image 20241014132706.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241014132745.webp" | relative_url }})

We search for cron tasks in the crontab file to see if something is running every x amount of time.

![]({{ "/assets/images/analytics/Pasted image 20241014132750.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241014132759.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241014132810.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241014132857.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241014133409.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241014133431.webp" | relative_url }})
...
![]({{ "/assets/images/analytics/Pasted image 20241014133437.webp" | relative_url }})
